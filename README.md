...
>
> ### 🗃 Исторический файл
> Данная ОС не будет обновляться и релизов новых **тоже не будет!** В
...
## 🔵 Требования
### Желательно Powerpoint 2016 (ниже лучше не рекомендуется, выше не пробовал)
### Имееть не сильно древний (слабый) компьютер/ноутбук
